...
export default function DealPage({
    ...
    return (
        ...
        >
            <div
                className="container mx-auto px-6 flex flex-col transition-all duration-700"
                style={{
            ...
            >
                ...
                {(firm?.tombstoneLayout || ['INFO', 'METRICS', 'MEDIA', 'NARRATIVE']).map((section) => {
                    ...
                    switch (section) {
                        case 'INFO':
                            return (
                                <div key="INFO" className={`${radiusClass} p-10 md:p-12 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700`} style={{ backgroundColor: sectionBg }}>
                                                    ...
                                                    <div className="flex flex-col gap-4 items-center md:items-end">
                                                        {members.map((m: any) => (
                                                            <div key={m.id} className="flex items-center gap-4">
                                                                ...
                                                                <div className={`h-14 w-14 overflow-hidden ${subRadiusClass} border-4 border-white shadow-xl`}>
                        ...
                        case 'METRICS':
                            return (
                                <div key="METRICS" className={`${radiusClass} p-10 md:p-12 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 overflow-hidden`} style={{ backgroundColor: sectionBg }}>
                        ...
                        case 'MEDIA':
                            return (
                                <div key="MEDIA" className="w-full animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
                                    <div className={`relative group ${radiusClass} overflow-hidden shadow-2xl border-8 border-white/5 bg-black/20 aspect-[4/5] md:aspect-[16/10] lg:aspect-[4/5]`} style={{ backgroundColor: sectionBg }}>
                                            ...
                                            >
                                                {allImages.length > 0 && (
                                                    (allImages[currentIndex]?.toLowerCase().includes('.mp4') || allImages[currentIndex]?.toLowerCase().includes('.mov')) ? (
                                                        <video src={allImages[currentIndex]} autoPlay muted loop playsInline className="h-full w-full object-cover" />
                                                    ) : (
                                                        <img src={allImages[currentIndex]} className="h-full w-full object-cover" alt="" />
                                                    )
                                                )}
                                            </motion.div>
                                        </AnimatePresence>
                        ...
                        case 'NARRATIVE':
                            return (
                                <div key="NARRATIVE" className={`${radiusClass} p-12 md:p-20 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400`} style={{ backgroundColor: sectionBg }}>
